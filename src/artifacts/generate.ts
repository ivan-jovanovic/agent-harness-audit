...
function buildTokens(projectPath: string, evidence: RepoEvidence, input: AuditInput): Record<string, string> {
  ...
  const claudeCodeSection = input.tool === "claude-code" ? CLAUDE_CODE_SECTION : "";
  ...
  return {
    ...
    TOOL: input.tool,
    CLAUDE_CODE_SECTION: claudeCodeSection,
  };
}
...
export async function generateArtifacts(
  ...
  const tokens = buildTokens(projectPath, evidence, input);
